...
\subsection{Dataset}
\input{sections/methodology/dataset/main}

\subsection{Models}
\input{sections/methodology/models/main}

\subsection{Metrics}
\input{sections/methodology/metrics/main}

\subsection{Experiments}
\input{sections/methodology/experiments/main}

\subsection{Statistical analysis}
\input{sections/methodology/statistical_analysis/main}
